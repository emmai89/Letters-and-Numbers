package com.mannycodes.gamelogic;
...
public class Letters {
    ...
    private Set<String> readDictionary() {
    Set<String> dictionary = new HashSet<>();
    
    ClassLoader classloader = Thread.currentThread().getContextClassLoader();
    InputStreamReader streamReader = new InputStreamReader(classloader.getResourceAsStream("dictionary.csv"), StandardCharsets.UTF_8);
